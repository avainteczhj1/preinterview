...
def sentences2idx(sentences, words):
    ...
    seq1=[]
    for i in sentences:
        seq1.append(getSeq(str(i),words))
...
def sentiment2idx(sentiment_file, words):
    ...
    """
    f = open(sentiment_file,'r',encoding='utf-8')
    lines = f.readlines()
    golds = []
    seq1 = []
    for i in lines:
...
def sim2idx(sim_file, words):
    ...
    """
    f = open(sim_file,'r',encoding='utf-8')
    lines = f.readlines()
    golds = []
    seq1 = []
    seq2 = []
...
def getIDFWeight(wordfile, save_file=''):
    ...
    if save_file:
        pickle.dump(weight4ind, open(save_file, 'w',encoding='utf-8'))
    return weight4ind
